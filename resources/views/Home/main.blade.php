                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-9 col-md-10">
                            <div class="hero__caption">
                                ...
                                <h1 style="font-size: 100px" data-animation="fadeInLeft" data-delay="0.4s">Warm Guys Gym</h1>
            ...
            <div class="row Device">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-cat text-center mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s" >
                        <div class="cat-icon">
                            <img class="img-fluid" src="img/{{ $device->hinh }}"  style="max-height: 300px"  alt="">
                        </div>
                        <div class="cat-cap">
                            <h5><a href="">{{ $device->tenTB }}</a></h5>
